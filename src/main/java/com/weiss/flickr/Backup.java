...
/**
 * A simple program to backup all of a users private and public photos in a
 * photoset aware manner. If photos are classified in multiple photosets, they
 * will be copied. Its a sample, its not perfect :-)
 * 
...
public class Backup {
	...
	public static void main(String[] args) throws Exception {
		...
		Backup bf = new Backup(args[0], args[1], args[2], new File(System.getProperty("user.home") + File.separatorChar
				+ ".flickrAuth"));
